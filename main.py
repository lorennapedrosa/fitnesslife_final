...
def get_root(request: Request):
    ...
    return templates.TemplateResponse("pages/usuario/index.html", view_model)
...
def get_root(request: Request):
    ...
    return templates.TemplateResponse("pages/usuario/login.html", view_model)
...
def get_root(request: Request):
    ...
    return templates.TemplateResponse("pages/usuario/inscrever.html", view_model)

@app.get("/recuperar_senha", response_class=HTMLResponse)
async def get_recuperar_senha(request: Request):
    view_model = {"request": request}
    return templates.TemplateResponse("pages/usuario/esqueceu_sua_senha.html", view_model)
...
async def get_verificar_codigo(request: Request):
    ...
    return templates.TemplateResponse("pages/usuario/verificar_codigo.html", view_model)
...
async def get_redefinir_senha(request: Request):
    ...
    return templates.TemplateResponse("pages/usuario/redefinir_senha.html", view_model)
...
def get_root(request: Request):
    ...
    return templates.TemplateResponse("pages/cliente/configuracoes.html", common_view_params(request))
