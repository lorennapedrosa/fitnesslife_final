...
async def checar_autorizacao(request: Request):
    ...
    area_do_usuario = request.url.path.startswith("pages/usuario")
    area_do_cliente = request.url.path.startswith("pages/cliente")
    area_do_nutricionista = request.url.path.startswith("pages/nutricionista")
    area_do_personal = request.url.path.startswith("pages/personal")
    if (area_do_usuario or area_do_cliente or area_do_nutricionista or area_do_personal) and not usuario.perfil:
